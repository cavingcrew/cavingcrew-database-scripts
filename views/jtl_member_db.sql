...
select
  ...
  max(case when `um`.`meta_key` = 'admin-wednesday-requests-notes' then `um`.`meta_value` end) AS `admin-wednesday-requests-notes`,
  max(case when `um`.`meta_key` = 'admin-outdoors-requests-notes' then `um`.`meta_value` end) AS `admin-outdoors-requests-notes`,
  max(case when `um`.`meta_key` = 'admin-weekend-requests-notes' then `um`.`meta_value` end) AS `admin-weekend-requests-notes`,
  max(case when `um`.`meta_key` = 'admin-training-requests-notes' then `um`.`meta_value` end) AS `admin-training-requests-notes`,
  max(case when `um`.`meta_key` = 'admin-vacation-requests-notes' then `um`.`meta_value` end) AS `admin-vacation-requests-notes`,
  max(case when `um`.`meta_key` = 'social-menu-choice-one' then `um`.`meta_value` end) AS `social-menu-choice-one`,
  max(case when `um`.`meta_key` = 'social-menu-choice-two' then `um`.`meta_value` end) AS `social-menu-choice-two`,
  max(case when `um`.`meta_key` = 'social-menu-choice-three' then `um`.`meta_value` end) AS `social-menu-choice-three`,
  max(case when `um`.`meta_key` = 'admin-social-requests-notes' then `um`.`meta_value` end) AS `admin-social-requests-notes`,
  max(case when `um`.`meta_key` = 'climbing-trad-grades' then `um`.`meta_value` end) AS `climbing-trad-grades`,
  max(case when `um`.`meta_key` = 'climbing-sport-grades' then `um`.`meta_value` end) AS `climbing-sport-grades`,
  max(case when `um`.`meta_key` = 'climbing-trad-skills-extra' then `um`.`meta_value` end) AS `climbing-trad-skills-extra`,
  max(case when `um`.`meta_key` = 'climbing-sport-skills-extra' then `um`.`meta_value` end) AS `climbing-sport-skills-extra`,
  max(case when `um`.`meta_key` = 'climbing-indoors-skills-passing-on' then `um`.`meta_value` end) AS `climbing-indoors-skills-passing-on`,
  max(case when `um`.`meta_key` = 'climbing-trad-skills-passing-on' then `um`.`meta_value` end) AS `climbing-trad-skills-passing-on`,
  max(case when `um`.`meta_key` = 'climbing-sport-skills-passing-on' then `um`.`meta_value` end) AS `climbing-sport-skills-passing-on`,
  max(case when `um`.`meta_key` = 'climbing-bouldering-indoors-grades' then `um`.`meta_value` end) AS `climbing-bouldering-indoors-grades`,
  max(case when `um`.`meta_key` = 'climbing-bouldering-outdoors-grades' then `um`.`meta_value` end) AS `climbing-bouldering-outdoors-grades`,
  max(case when `um`.`meta_key` = 'climbing-indoors-leading-grades' then `um`.`meta_value` end) AS `climbing-indoors-leading-grades`,
  max(case when `um`.`meta_key` = 'climbing-indoors-toproping-grades' then `um`.`meta_value` end) AS `climbing-indoors-toproping-grades`,
  max(case when `um`.`meta_key` = 'admin-social-facebook-url' then `um`.`meta_value` end) AS `admin-social-facebook-url`,
  max(case when `um`.`meta_key` = 'admin-social-instagram-handle' then `um`.`meta_value` end) AS `admin-social-instagram-handle`,
  max(case when `um`.`meta_key` = 'admin-uninsured-climbers-alert-1' then `um`.`meta_value` end) AS `admin-uninsured-climbers-alert-1`,
  max(case when `um`.`meta_key` = 'admin-no-personal-insurance-disclaimer' then `um`.`meta_value` end) AS `admin-no-personal-insurance-disclaimer`,
  max(case when `um`.`meta_key` = 'stats_volunteer_for_numerator_cached' then `um`.`meta_value` end) AS `stats_volunteer_for_numerator_cached`,
  max(case when `um`.`meta_key` = 'stats_volunteer_for_but_no_attend_cached' then `um`.`meta_value` end) AS `stats_volunteer_for_but_no_attend_cached`,
  max(case when `um`.`meta_key` = 'stats_volunteer_for_denominator_cached' then `um`.`meta_value` end) AS `stats_volunteer_for_denominator_cached`,
  max(case when `um`.`meta_key` = 'stats_attendance_attended_cached' then `um`.`meta_value` end) AS `stats_attendance_attended_cached`,
  max(case when `um`.`meta_key` = 'stats_attendance_outdoor_thursday_attended_cached' then `um`.`meta_value` end) AS `stats_attendance_outdoor_thursday_attended_cached`,
  max(case when `um`.`meta_key` = 'stats_attendance_outdoor_day_attended_cached' then `um`.`meta_value` end) AS `stats_attendance_outdoor_day_attended_cached`,
  max(case when `um`.`meta_key` = 'stats_attendance_outdoor_saturday_attended_cached' then `um`.`meta_value` end) AS `stats_attendance_outdoor_saturday_attended_cached`,
  max(case when `um`.`meta_key` = 'stats_attendance_indoor_wednesday_attended_cached' then `um`.`meta_value` end) AS `stats_attendance_indoor_wednesday_attended_cached`,
  max(case when `um`.`meta_key` = 'stats_attendance_overnight_attended_cached' then `um`.`meta_value` end) AS `stats_attendance_overnight_attended_cached`,
  max(case when `um`.`meta_key` = 'stats_attendance_training_attended_cached' then `um`.`meta_value` end) AS `stats_attendance_training_attended_cached`,
  max(case when `um`.`meta_key` = 'stats_attendance_social_attended_cached' then `um`.`meta_value` end) AS `stats_attendance_social_attended_cached`,
  max(case when `um`.`meta_key` = 'stats_attendance_signups_cached' then `um`.`meta_value` end) AS `stats_attendance_signups_cached`,
  max(case when `um`.`meta_key` = 'stats_attendance_cancelled_cached' then `um`.`meta_value` end) AS `stats_attendance_cancelled_cached`,
  max(case when `um`.`meta_key` = 'stats_attendance_noregistershow_cached' then `um`.`meta_value` end) AS `stats_attendance_noregistershow_cached`,
  max(case when `um`.`meta_key` = 'stats_attendance_noshow_cached' then `um`.`meta_value` end) AS `stats_attendance_noshow_cached`,
  max(case when `um`.`meta_key` = 'stats_attendance_latebail_cached' then `um`.`meta_value` end) AS `stats_attendance_latebail_cached`,
  max(case when `um`.`meta_key` = 'stats_attendance_duplicate_cached' then `um`.`meta_value` end) AS `stats_attendance_duplicate_cached`,
  max(case when `um`.`meta_key` = 'stats_attendance_inprogress_cached' then `um`.`meta_value` end) AS `stats_attendance_inprogress_cached`,
  max(case when `um`.`meta_key` = 'stats_volunteer_for_but_no_volunteer_cached' then `um`.`meta_value` end) AS `stats_volunteer_for_but_no_volunteer_cached`,
  max(case when `um`.`meta_key` = 'scores_volunteer_reliability_score_cached' then `um`.`meta_value` end) AS `scores_volunteer_reliability_score_cached`,
  max(case when `um`.`meta_key` = 'scores_attendance_reliability_score_cached' then `um`.`meta_value` end) AS `scores_attendance_reliability_score_cached`,
  max(case when `um`.`meta_key` = 'scores_volunteer_value_cached' then `um`.`meta_value` end) AS `scores_volunteer_value_cached`,
  max(case when `um`.`meta_key` = 'scores_attendance_score_cached' then `um`.`meta_value` end) AS `scores_attendance_score_cached`,
  max(case when `um`.`meta_key` = 'scores_volunteer_score_cached' then `um`.`meta_value` end) AS `scores_volunteer_score_cached`,
  max(case when `um`.`meta_key` = 'scores_and_stats_cache_last_updated' then `um`.`meta_value` end) AS `scores_and_stats_cache_last_updated`,
  max(case when `um`.`meta_key` = 'cc_attendance_noted_date' then `um`.`meta_value` end) AS `cc_attendance_noted_date`,
  max(case when `um`.`meta_key` = 'cc_compliance_last_date_of_climbing' then `um`.`meta_value` end) AS `cc_compliance_last_date_of_climbing`,
  max(case when `um`.`meta_key` = 'milestones_3_badge' then `um`.`meta_value` end) AS `milestones_3_badge`,
  max(case when `um`.`meta_key` = 'milestones_3_badge_marked_given_at' then `um`.`meta_value` end) AS `milestones_3_badge_marked_given_at`,
  max(case when `um`.`meta_key` = 'milestones_3_badge_marked_given_by' then `um`.`meta_value` end) AS `milestones_3_badge_marked_given_by`,
  max(case when `um`.`meta_key` = 'milestones_5_band' then `um`.`meta_value` end) AS `milestones_5_band`,
  max(case when `um`.`meta_key` = 'milestones_5_band_marked_given_at' then `um`.`meta_value` end) AS `milestones_5_band_marked_given_at`,
  max(case when `um`.`meta_key` = 'milestones_5_band_marked_given_by' then `um`.`meta_value` end) AS `milestones_5_band_marked_given_by`,
  max(case when `um`.`meta_key` = 'cc_compliance_first_date_of_climbing' then `um`.`meta_value` end) AS `cc_compliance_first_date_of_climbing`,
  max(case when `um`.`meta_key` = 'competency_indoor_trip_director' then `um`.`meta_value` end) AS `competency_indoor_trip_director`,
  max(case when `um`.`meta_key` = 'competency_indoor_checkin' then `um`.`meta_value` end) AS `competency_indoor_checkin`,
  max(case when `um`.`meta_key` = 'competency_indoor_pairing' then `um`.`meta_value` end) AS `competency_indoor_pairing`,
  max(case when `um`.`meta_key` = 'competency_indoor_floorwalker' then `um`.`meta_value` end) AS `competency_indoor_floorwalker`,
  max(case when `um`.`meta_key` = 'competency_indoor_skillsharer' then `um`.`meta_value` end) AS `competency_indoor_skillsharer`,
  max(case when `um`.`meta_key` = 'competency_indoor_announcements' then `um`.`meta_value` end) AS `competency_indoor_announcements`,
  max(case when `um`.`meta_key` = 'competency_outdoor_trip_director' then `um`.`meta_value` end) AS `competency_outdoor_trip_director`,
  max(case when `um`.`meta_key` = 'competency_outdoor_group_maker' then `um`.`meta_value` end) AS `competency_outdoor_group_maker`,
  max(case when `um`.`meta_key` = 'competency_outdoor_message_maker' then `um`.`meta_value` end) AS `competency_outdoor_message_maker`,
  max(case when `um`.`meta_key` = 'competency_outdoor_crag_coordinator' then `um`.`meta_value` end) AS `competency_outdoor_crag_coordinator`,
  max(case when `um`.`meta_key` = 'competency_overnight_trip_director' then `um`.`meta_value` end) AS `competency_overnight_trip_director`,
  max(case when `um`.`meta_key` = 'competency_overnight_evening_meal' then `um`.`meta_value` end) AS `competency_overnight_evening_meal`,
  max(case when `um`.`meta_key` = 'competency_overnight_climbing_coordinator' then `um`.`meta_value` end) AS `competency_overnight_climbing_coordinator`,
  max(case when `um`.`meta_key` = 'competency_overnight_lift_coordinator' then `um`.`meta_value` end) AS `competency_overnight_lift_coordinator`,
  max(case when `um`.`meta_key` = 'competency_overnight_breakfast_lunch' then `um`.`meta_value` end) AS `competency_overnight_breakfast_lunch`,
  max(case when `um`.`meta_key` = 'competency_training_training_organiser' then `um`.`meta_value` end) AS `competency_training_training_organiser`,
  max(case when `um`.`meta_key` = 'competency_outdoor_skillsharer' then `um`.`meta_value` end) AS `competency_outdoor_skillsharer`,
  max(case when `um`.`meta_key` = 'competency_social_social_organiser' then `um`.`meta_value` end) AS `competency_social_social_organiser`,
  max(case when `um`.`meta_key` = 'admin_new_indoor_clan_join_admin_team' then `um`.`meta_value` end) AS `admin_new_indoor_clan_join_admin_team`,
  max(case when `um`.`meta_key` = 'admin_parthian_clan_join_admin_team' then `um`.`meta_value` end) AS `admin_parthian_clan_join_admin_team`,
  max(case when `um`.`meta_key` = 'climbing_outdoor_leaving_postcode' then `um`.`meta_value` end) AS `climbing_outdoor_leaving_postcode`,
  max(case when `um`.`meta_key` = 'climbing_outdoor_leaving_postcode_geocoded' then `um`.`meta_value` end) AS `climbing_outdoor_leaving_postcode_geocoded`,
  max(case when `um`.`meta_key` = 'climbing_outdoor_leaving_postcode_geocoded_last_updated' then `um`.`meta_value` end) AS `climbing_outdoor_leaving_postcode_geocoded_last_updated`,
  max(case when `um`.`meta_key` = 'admin_outdoor_volunteering_team' then `um`.`meta_value` end) AS `admin_outdoor_volunteering_team`,
